...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return seq_tokens, attn_weight, cls_token  # L(patches number)ND', NS(patches number), ND'
...
class CLIP(nn.Module):
    ...
    def encode_text(self, text, key_padding_mask):
        ...
        return seq_tokens, attn_weight, new_key_padding_mask, EOS_token  # L(max_words)ND', NL(max_words): attn_weight=0 if is after EOS token, NL(max_words), ND'
